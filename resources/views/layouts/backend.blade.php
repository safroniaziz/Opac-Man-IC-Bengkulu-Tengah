...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a class="logo">
      ...
      <span class="logo-lg" style="font-size:14px;"><b>OPAC </b>MAN IC</span>
    </a>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image" style="margin-top:6px;">
          <img src="{{ asset('assets/images/manic.png') }}" style="height:auto;" class="img-circle" alt="User Image">
        </div>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Perpustakaan MAN IC Bengkulu Tengah
        <small>Online Public Access Catalog</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-home"></i> OPAC</a></li>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2021 <a>MAN IC Bengkulu Tengah</a>.</strong> All rights
    reserved.
  </footer>
...
<script src="{{ asset('assets/lte/validator/validator.min.js') }}"></script>
